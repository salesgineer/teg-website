...
**Last Updated:** 2025-11-08 12:07 Riga Time
...
- **Approach:** "Vibe coding" - An AI-assisted development technique where the developer describes projects/tasks to LLMs in natural language, which generate code. The developer focuses on goals, testing, and iterative feedback rather than manually writing or deeply reviewing code line-by-line. Coined by Andrej Karpathy (OpenAI co-founder) in 2025. The developer guides, tests, and provides feedback while the LLM handles implementation details.
...
- **Verify spec clarity:** Before implementing, confirm requirements are specific and unambiguous
- **Ask clarifying questions:** When specs are vague or multiple valid approaches exist
- **Confirm assumptions:** List what you're assuming and verify with developer
...
**TRUST & EFFECTIVENESS:** LLMs should make effective coding decisions and choose appropriate approaches. The focus is on **maximizing effectiveness**, not minimizing context usage.

**LLM AUTONOMY:** LLMs should:
- Choose the most effective approach for the task at hand
- Use appropriate tools and patterns without artificial constraints
- Code directly when it's the most efficient solution
- Delegate when it genuinely makes sense, not as a rigid rule

### Spec Clarity & Ambiguity Checks (CRITICAL)

**MANDATORY VERIFICATION:** Before implementing ANY feature or fix, LLMs MUST:

1. **Check Spec Specificity:**
   - Are requirements clear and specific enough to implement?
...
2. **Proactively Ask Questions When:**
   - Specs are vague or underspecified
   - Multiple implementation approaches exist with different trade-offs
   - Technical decisions require user preference (e.g., library choice, architecture pattern)
   - Edge case behavior is unclear
   - Requirements conflict or seem incomplete

3. **Confirm Understanding:**
   - Summarize your understanding of the task before implementing
   - List any assumptions you're making
   - Flag any areas of uncertainty
   - Ask for clarification rather than guessing

**REMEMBER:** Developer is a beginner. Don't assume familiarity with technical nuances. It's better to over-communicate and verify understanding than to implement based on incorrect assumptions.

### Quality Over Efficiency

- **Effectiveness First:** Choose approaches that work best, not that save tokens
- **Clear Communication:** Explain decisions and trade-offs thoroughly
- **Validate Understanding:** Ensure developer comprehends what's being built
- **Educational Focus:** Teach while implementing
- **No Artificial Constraints:** Use best judgment, not rigid delegation rules

### Debugging Methodology

When investigating issues:

1. **Understand the Problem:** Reproduce it, gather evidence, collect logs
2. **Consider Multiple Causes:** Don't jump to first conclusion (list 3-5 hypotheses)
3. **Test Systematically:** Verify which hypothesis explains ALL symptoms
4. **Confirm Root Cause:** Test that the suspected cause actually creates the issue
5. **Ask Before Major Changes:** If the fix is complex or has trade-offs, explain options to developer

**Key Principle:** Verify causation, not correlation. Unusual code ≠ Broken code.
